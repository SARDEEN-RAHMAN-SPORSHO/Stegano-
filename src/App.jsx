...
const TextSteganography = () => {
  ...
  // Convert text to zero-width characters - FIXED VERSION
  const textToZeroWidth = (text) => {
    let binary = '';
    for (let i = 0; i < text.length; i++) {
      const charCode = text.charCodeAt(i);
      // Convert to base4 (2 bits per character) and pad to 8 digits
      const base4 = charCode.toString(4).padStart(8, '0');
      binary += base4;
    }
  ...
  // Convert zero-width chars back to text - FIXED VERSION
  const zeroWidthToText = (zeroWidth) => {
    ...
    for (let i = 0; i < paddedBinary.length; i += 8) {
      const chunk = paddedBinary.substr(i, 8);
      if (chunk.length === 8) {
  ...
  const handleDecode = async () => {
    ...
    try {
      ...
      // Extract zero-width characters - FIXED VERSION
      let hidden = '';
          ...
          <div style={{...styles.card, textAlign: 'center'}}>
            ...
            <div style={{marginTop: '2rem', textAlign: 'center'}}>
              <p style={{color: '#64748b', fontSize: '0.75rem', letterSpacing: '1px'}}>
                SECURE SYSTEM • v5.0 • QUANTUM ENCRYPTION
              </p>
            </div>
          </div>
        </div>
          ...
          >
            <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', marginBottom: '1.5rem'}}>
              ...
              <div style={{textAlign: 'left'}}>
                ...
                <p style={{color: '#a78bfa', margin: 0}}>AES-256 + 3-Layer Encryption</p>
              </div>
            </div>
            <div style={{color: '#cbd5e1', textAlign: 'left', marginBottom: '1.5rem'}}>
              <p style={{marginBottom: '0.5rem'}}>• AES-256 simulation with S-Box</p>
              <p style={{marginBottom: '0.5rem'}}>• 100,000 iteration key derivation</p>
              <p style={{marginBottom: '0.5rem'}}>• 3-layer CBC mode encryption</p>
              <p>• Military-grade security</p>
            </div>
            <div style={{display: 'flex', gap: '0.5rem', justifyContent: 'center'}}>
              <span style={{...styles.badge, backgroundColor: 'rgba(139, 92, 246, 0.2)'}}>AES-256</span>
              <span style={{...styles.badge, backgroundColor: 'rgba(16, 185, 129, 0.2)', color: '#34d399'}}>3 LAYERS</span>
            </div>
          </div>
          ...
          >
            <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', marginBottom: '1.5rem'}}>
              ...
              <div style={{textAlign: 'left'}}>
                ...
                <p style={{color: '#f9a8d4', margin: 0}}>Quantum-Resistant 5-Layer</p>
              </div>
            </div>
            <div style={{color: '#cbd5e1', textAlign: 'left', marginBottom: '1.5rem'}}>
              <p style={{marginBottom: '0.5rem'}}>• 250,000 iteration quantum key derivation</p>
              <p style={{marginBottom: '0.5rem'}}>• 5-layer quantum-resistant encryption</p>
              <p style={{marginBottom: '0.5rem'}}>• Quantum entanglement simulation</p>
              <p>• Post-quantum cryptography</p>
            </div>
            <div style={{display: 'flex', gap: '0.5rem', justifyContent: 'center'}}>
              <span style={{...styles.badge, backgroundColor: 'rgba(236, 72, 153, 0.2)', color: '#f9a8d4'}}>QUANTUM</span>
              <span style={{...styles.badge, backgroundColor: 'rgba(16, 185, 129, 0.2)', color: '#34d399'}}>5 LAYERS</span>
            </div>
          </div>
        </div>
      </div>
